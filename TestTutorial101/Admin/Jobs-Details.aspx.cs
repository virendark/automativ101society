    ...
    public partial class Jobs_Details : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            try
            {
                if (ddlState.SelectedValue != "-1")
                {
                    ...
                    cmd.Parameters.AddWithValue("@FileNames", fn1);
                    ...
                    if (rowsAffected > 0)
                    {
                        ...
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alertscript", scripts, true);
                        Session["JobID"] = null;
                       Response.Redirect("View-Jobs.aspx");
                    }
                    else
                    {
                        string scripts = "alert('Some error occur.');";
        ...
        public void GeneralImageClick()
        {
            if (FileUpload1.HasFile)
            {
                ...
                fn1 = Path.GetFileName(FileUpload1.PostedFile.FileName);
        ...
        protected void btnCancel_Click(object sender, EventArgs e)
        {
            ...
            txtDateFrom.Text = "";
            txtHrName.Text = "";
            txtInterviewDateTo.Text = "";
            txtJobDesc.Text = "";
            txtJobTitle.Text = "";
            txtMobile.Text = "";
            txtNoVacancy.Text = "";
            txtOtherCondition1.Text = "";
            txtOtherCondition2.Text = "";
            txtOtherQualification.Text = "";
            txtRemarks.Text = "";
            txtSpecialCourse.Text = "";
