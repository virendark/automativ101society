<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true" CodeBehind="Student-Details.aspx.cs" Inherits="TestTutorial101.Student_Details" %>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                             <div class="col-lg-12 pull-right">
                                                      <asp:Button CssClass="btn btn-primary  btn-flat pull-left " ID="BtnContinue" runat="server" Text="Continue for Apply"  OnClick="BtnContinue_Click"/>
                                                 <asp:Button CssClass="btn btn-primary  btn-flat pull-right" ID="BtnEditRecord" runat="server" Text="Edit"  OnClick="BtnEditRecord_Click"/></div>
