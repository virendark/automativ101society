<%@ Page Title="" Language="C#" MasterPageFile="~/HomeMaster.Master" AutoEventWireup="true" CodeBehind="All-Students.aspx.cs" Inherits="TestTutorial101.All_Students" %>
        ...
        <div class="container">
            ...
            <div class="col-lg-12" style="margin-top: 15px; margin-left: 20px;">
                <div class="alert alert-info">
                    ...
                    <hr />
                    <asp:GridView ID="gvStudents" runat="server" AutoGenerateColumns="false" OnRowCommand="gvStudents_RowCommand" OnRowEditing="gvStudents_RowEditing">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Edit">
                                <ItemTemplate>
                                    ...
                                    <asp:LinkButton ID="lnkEdit" runat="server" CausesValidation="false" CommandName="edit" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id") %>'>Block</asp:LinkButton>

                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Delete">
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkDelete" runat="server" CausesValidation="false" CommandName="Delete" OnClientClick="return confirm('Are you sure you want to delete this record ?');"  CommandArgument='<%# DataBinder.Eval(Container.DataItem, "Id") %>'>UnBlock</asp:LinkButton>
